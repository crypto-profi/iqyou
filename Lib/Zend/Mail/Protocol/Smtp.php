...
class Zend_Mail_Protocol_Smtp extends Zend_Mail_Protocol_Abstract
{
    ...
    static $MAIL_PATH = '/var/mailSender/spool/';
    ...
    {
        $this->_socket = self::$MAIL_PATH . md5(microtime(true) . rand()) . '.eml';
        return true;
    }
    ...
    protected function _send($request)
    {
        ...
        $result = file_put_contents($this->_socket, $request . self::EOL, FILE_APPEND);
